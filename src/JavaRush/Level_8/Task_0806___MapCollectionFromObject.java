...
*/
public class Task_0806___MapCollectionFromObject {
    public static void main(String[] args) {
        ...
        for (Map.Entry<String, Object> mapToString : map.entrySet()) {
            System.out.println(mapToString.getKey() + " - " +mapToString.getValue());
        }
